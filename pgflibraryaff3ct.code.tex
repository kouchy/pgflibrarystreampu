...
\newcommand{\task}[8][]{
  ...
  \ifthenelse{\equal{\tskpos}{}} {
    \ifthenelse{\equal{#1}{}} {
      \node[\tskstyle, align=center, minimum height=\tskrealminheight] (\tskid) {\tsklabl};
    }{
    ...
    \ifthenelse{\equal{#1}{}} {
      \node[\tskstyle, align=center, minimum height=\tskrealminheight] (\tskid) at (\tskposx,\tskposy) {\tsklabl};
    }{
    ...
    \foreach \i in {0,...,\nsckifmone} {
      ...
      \ifnum \numexpr \i  < \nscki
        ...
        \ifthenelse{\equal{\scknum}{yes}} {
          ...
          \node[sinlbl, at=(\tskid_si\sckiid.center)] (\tskid_si\sckiid_lbl) {\sckiid};
        }{}
      \else
        ...
        \ifthenelse{\equal{\scknum}{yes}} {
          \node[sckshdw, at=(\tskid.\tsksiside), yshift=\sckiyshift] (\tskid_si\sckiid_shdw) {};
          \node[sfwdlbl, at=(\tskid_si\sckiid.center)] (\tskid_si\sckiid_lbl) {\sckiid};
        }{}
      \fi
    }
  \fi
    ...
    \foreach \i in {0,...,\nsckofmone} {
      ...
      \ifnum \numexpr \i  < \nscko
        ...
        \ifthenelse{\equal{\scknum}{yes}} {
          ...
          \node[soutlbl, at=(\tskid_so\sckoid.center)] (\tskid_so\sckoid_lbl) {\sckoid};
        }{}
      \else
        ...
        \ifthenelse{\equal{\scknum}{yes}} {
          \node[sckshdw, at=(\tskid.\tsksoside), yshift=\sckoyshift] (\tskid_so\sckoid_shdw) {};
          \node[sfwdlbl, at=(\tskid_so\sckoid.center)] (\tskid_so\sckoid_lbl) {\sckoid};
        }{}
      \fi
    }
  \fi
  ...
  \foreach \i in {0,...,\ntskmone}{
    ...
    \ifthenelse{\equal{\nclones}{}} {}
    {
      \ifnum \numexpr\nclones > 0
        \foreach \c in {1,...,\nclones}{
          \pgfmathsetmacro{\cid}{\nclones-\c}
          \pgfmathsetmacro{\clnshft}{(\cid)*0.075cm}
          ...
          \ifthenelse{\equal{#1}{}} {
            \begin{scope}[on background layer]
              \path let
                ...
                \n1={veclen(\p1)-\pgflinewidth},
                \n2={veclen(\p2)-\pgflinewidth},
                in node [task, taskcln, at=(\curtsk), minimum width=\n1, minimum height=\n2, inner sep=0.0cm, xshift=\clnshft, yshift=\clnshft] (\curtsk_cln\cid) {};
            \end{scope}
          }{
            \begin{scope}[on background layer]
              \path let
                ...
                \n1={veclen(\p1)-\pgflinewidth},
                \n2={veclen(\p2)-\pgflinewidth},
                in node [task, taskcln, at=(\curtsk), minimum width=\n1, minimum height=\n2, inner sep=0.0cm, xshift=\clnshft, yshift=\clnshft, #1] (\curtsk_cln\cid) {};
            \end{scope}
          }
          %hack
          \path let
            ...
            \n1={veclen(\p1)-\pgflinewidth},
            \n2={veclen(\p2)-\pgflinewidth},
            in node [task, taskcln, inv, at=(\curtsk), minimum width=\n1, minimum height=\n2, inner sep=0.0cm, xshift=\clnshft, yshift=\clnshft] (\curtsk clnn\c) {};
          ...
          \foreach \si in {1,...,100}{
            \@nodedefined{\curtsk_si\si}{
              ...
              \ifthenelse{\equal{#1}{}} {
                \begin{scope}[on background layer]
                  \node[\sckstya, \sckstyb, at=(\curtsk_si\si), xshift=\clnshft, yshift=\clnshft] (\curtsk_cln\cid_si\si) {};
                \end{scope}
              }{
                \begin{scope}[on background layer]
                  \node[\sckstya, \sckstyb, at=(\curtsk_si\si), xshift=\clnshft, yshift=\clnshft, #1] (\curtsk_cln\cid_si\si) {};
                \end{scope}
              }
              %hack
              \node[\sckstya, \sckstyb, inv, at=(\curtsk_si\si), xshift=\clnshft, yshift=\clnshft] (\curtsk clnn\c si\si) {};
            }{
              \breakforeach
            }
          }
          ...
          \foreach \so in {1,...,100}{
            \@nodedefined{\curtsk_so\so}{
              ...
              \ifthenelse{\equal{#1}{}} {
                \begin{scope}[on background layer]
                  \node[\sckstya, \sckstyb, at=(\curtsk_so\so), xshift=\clnshft, yshift=\clnshft] (\curtsk_cln\cid_so\so) {};
                \end{scope}
              }{
                \begin{scope}[on background layer]
                  \node[\sckstya, \sckstyb, at=(\curtsk_so\so), xshift=\clnshft, yshift=\clnshft, #1] (\curtsk_cln\cid_so\so) {};
                \end{scope}
              }
              %hack
              \node[\sckstya, \sckstyb, inv, at=(\curtsk_so\so), xshift=\clnshft, yshift=\clnshft] (\curtsk clnn\c so\so) {};
            }{
              \breakforeach
            }
          }
...
\newcommand{\module}[4][]{
  ...
  \foreach \i in {0,...,\ntskmone}{
    ...
    \foreach \cid in {1,...,100}{
      \@nodedefined{\curtsk clnn\cid}{
        \xdef\tclnids{\tclnids (\curtsk clnn\cid)}
        \def\sclnids{};
        \foreach \si in {1,...,100}{
          \@nodedefined{\curtsk clnn\cid si\si}{
            \xdef\sclnids{\sclnids (\curtsk clnn\cid si\si)}
          }{
            \breakforeach
          }
        }
        \foreach \so in {1,...,100}{
          \@nodedefined{\curtsk clnn\cid so\so}{
            \xdef\sclnids{\sclnids (\curtsk clnn\cid so\so)}
          }{
            \breakforeach
          }
        }
...
\newcommand{\sequence}[5][]{
  ...
  \foreach \i in {0,...,\ntskmone}{
    ...
    \@moduledefined{\curobj}{
      ...
      \def\tclnids{};
      \foreach \cid in {1,...,100}{
        \@nodedefined{\curobj clnn\cid}{
          \xdef\tclnids{\tclnids (\curobj clnn\cid)}
          \def\sclnids{};
          \foreach \si in {1,...,100}{
            \@nodedefined{\curobj clnn\cid si\si}{
              \xdef\sclnids{\sclnids (\curobj clnn\cid si\si)}
            }{
              \breakforeach
            }
          }
          \foreach \so in {1,...,100}{
            \@nodedefined{\curobj clnn\cid so\so}{
              \xdef\sclnids{\sclnids (\curobj clnn\cid so\so)}
            }{
              \breakforeach
            }
          }
  ...
  % start drawing
  \ifthenelse{\equal{#1}{}} {
    \node[seq, label={[Paired-11,align=center]below:\seqlabl}, fit=\ids] (\seqid) {};
  }{
...
\newcommand{\legend}[1][]{
  \begin{scope}[#1]
    \node[draw=Paired-1, rounded corners=0pt, minimum height=0.3cm, minimum width=0.7cm, text=Paired-1, label={right:Parallel task}] (l1) at (+0.0, 1.9) {};
    ...
    \node[draw=Paired-3, rounded corners=0pt, minimum height=0.3cm, minimum width=0.7cm, text=Paired-3, dashed, label={right:Module}] (l3) at (+0.0, 0.9) {};
    ...
    \node[draw=Paired-11, rounded corners=0pt, minimum height=0.3cm, minimum width=0.7cm, dashed, label={right:Sequence or pipeline stage}] (l7) at (+7.0, 1.9) {};
    \node[] (l8) at (11.15, 1.9) {};
    \draw[thick] plot [smooth,tension=0.7, xshift=7cm, yshift=1.25cm] coordinates {(0,0.375) (0.056,0.3228) (-0.0375,0.234) (0.075,0.093) (0,0)} node (l9){};
    \node[] (l10) at (8.625, 1.4) {Software thread};
    \node[draw, fit=(l1) (l2) (l3) (l4) (l5) (l6) (l7) (l8) (l10)] (legend) {};
  \end{scope}
}
