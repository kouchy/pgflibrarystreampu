        ...
        \foreach \c in {0,...,\nclones}{
          ...
          \foreach \si in {1,...,100}{
            \@nodedefined{\curtsk_si\si}{
              ...
              \ifthenelse{\equal{#1}{}} {
                \begin{scope}[on background layer]
                  \node[\sckstya, \sckstyb, at=(\curtsk_si\si), xshift=\clnshft, yshift=\clnshft] (\curtsk_si\si_cln\cid) {};
                \end{scope}
              }{
                \begin{scope}[on background layer]
                  \node[\sckstya, \sckstyb, at=(\curtsk_si\si), xshift=\clnshft, yshift=\clnshft, #1] (\curtsk_si\si_cln\cid) {};
                \end{scope}
              }
            }{
              \breakforeach
          ...
          \foreach \so in {1,...,100}{
            \@nodedefined{\curtsk_so\so}{
              ...
              \ifthenelse{\equal{#1}{}} {
                \begin{scope}[on background layer]
                  \node[\sckstya, \sckstyb, at=(\curtsk_so\so), xshift=\clnshft, yshift=\clnshft] (\curtsk_so\so_cln\cid) {};
                \end{scope}
              }{
                \begin{scope}[on background layer]
                  \node[\sckstya, \sckstyb, at=(\curtsk_so\so), xshift=\clnshft, yshift=\clnshft, #1] (\curtsk_so\so_cln\cid) {};
                \end{scope}
              }
            }{
              \breakforeach
