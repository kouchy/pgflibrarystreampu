...
\tikzset{ taskcln/.style = {draw=gray!30!white} }
\tikzset{ scln/.style    = {draw=gray!30!white, fill=white} }
        ...
        \foreach \c in {0,...,\nclones}{
          ...
          \foreach \si in {1,...,100}{
            \@nodedefined{\curtsk_si\si}{
              \begin{scope}[on background layer]
                \node[sin, scln, at=(\curtsk_si\si), xshift=\clnshft, yshift=\clnshft] (\curtsk_si\si_cln\cid) {};
              \end{scope}
            }{
              \breakforeach
            }
          ...
          \foreach \so in {1,...,100}{
            \@nodedefined{\curtsk_so\so}{
              \begin{scope}[on background layer]
                \node[sout, scln, at=(\curtsk_so\so), xshift=\clnshft, yshift=\clnshft] (\curtsk_so\so_cln\cid) {};
              \end{scope}
            }{
              \breakforeach
            }
