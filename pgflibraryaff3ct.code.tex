...
\newcommand{\select}[6][]{
  \ifnum \numexpr #5 > 0
    \task [thick,densely dashdotted,#1] {#2} {#3} {#4} {#5} {1} {0} {#6,"sckn"};
  \fi
}
...
\newcommand{\commute}[6][]{
  \ifnum \numexpr #5 > 0
    \task [thick,densely dashdotted,#1] {#2} {#3} {#4} {2} {#5} {0} {#6,"sckn"};
  \fi
}
...
\newcommand{\legend}[1][]{
  \begin{scope}[#1]
    ...
    \node[draw=Paired-1, rounded corners=0pt, minimum height=0.3cm, minimum width=0.7cm, text=Paired-3, thick, densely dashdotted, label={right:Ctrl flow task}] (l3) at (+0.0, 0.9) {};
    ...
    \node[draw=Paired-3, rounded corners=0pt, minimum height=0.3cm, minimum width=0.7cm, text=Paired-3, dashed, label={right:Module}] (l8) at (+7.0, 1.4) {};
    \node[] (l9) at (11.15, 1.9) {};
