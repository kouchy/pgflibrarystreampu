...
\begin{document}
  \begin{tikzpicture}
    ...
    %     -------                          --   ------  -----               --- ---- ---- ----------
    \task                                  {t1} {0, 0}  {$t_1$}             {0} {2}  {0}  {"seq"};
    \task [right=1.0cm of t1]              {t2} {}      {$t_2$}             {1} {0}  {1}  {};
    \task [right=1.0cm of t2]              {t3} {}      {$t_3$}             {1} {1}  {0}  {};
    \task [right=1.0cm of t3]              {t4} {}      {big task\\($t_4$)} {2} {3}  {0}  {"seq"};
    \task [right=1.0cm of t4]              {t5} {}      {$t_5$}             {2} {1}  {0}  {};
    \task [below=2.5cm of t5, xshift=-2cm] {t6} {}      {$t_6$}             {2} {3}  {0}  {"rev","seq"};
    \task [left =1.0cm of t6]              {t7} {}      {$t_7$}             {1} {0}  {2}  {"rev"};
