...
\begin{document}
  \begin{tikzpicture}
    ...
    %      -------                                       ----------       --   -----
    \stage [minimum height=3.00cm]                       {"m1","m2","t3"} {s1} {Stage 1}
    \stage [minimum width=4.50cm, minimum height=3.00cm] {"t4","t5"}      {s2} {Stage 2}
    \stage [minimum width=5.75cm, minimum height=2.25cm] {"t6","t7","t8"} {s3} {Stage 3}
