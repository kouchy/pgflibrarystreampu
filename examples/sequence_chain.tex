...
\begin{document}
  \begin{tikzpicture}
    ...
    \task {right=1.0cm of t1}              {t2} {"nopos"} {$t_2$}             {1} {0}  {1}  {"noattr"};
    \task {right=1.0cm of t2}              {t3} {"nopos"} {$t_3$}             {1} {1}  {0}  {"noattr"};
    \task {right=1.0cm of t3}              {t4} {"nopos"} {big task\\($t_4$)} {2} {3}  {0}  {"seq"};
    \task {right=1.0cm of t4}              {t5} {"nopos"} {$t_5$}             {2} {1}  {0}  {"noattr"};
    \task {below=2.5cm of t5, xshift=-2cm} {t6} {"nopos"} {$t_6$}             {2} {3}  {0}  {"rev","seq"};
    \task {left =1.0cm of t6}              {t7} {"nopos"} {$t_7$}             {1} {0}  {2}  {"rev"};
    \task {left =1.0cm of t7}              {t8} {"nopos"} {$t_8$}             {2} {0}  {0}  {"rev"};
